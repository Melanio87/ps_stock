...
public class Productos implements Serializable {
    ...
    private Double proUtilidad;
    private Double proDesMay;
    ...
    public Double getProUtilidad() {
        return proUtilidad;
    }

    public void setProUtilidad(Double proUtilidad) {
        this.proUtilidad = proUtilidad;
    }

    public Double getProDesMay() {
        return proDesMay;
    }

    public void setProDesMay(Double proDesMay) {
        this.proDesMay = proDesMay;
    }
    ...
    public Integer getProUnidad() {
        return proUnidad;
    }

    public void setProUnidad(Integer proUnidad) {
        this.proUnidad = proUnidad;
    }

    @Override
    public String toString() {
        return "Productos{" + "changeSupport=" + changeSupport + ", proCodigo=" + proCodigo + ", proDescri=" + proDescri + ", proPre1=" + proPre1 + ", proPre2=" + proPre2 + ", proPre3=" + proPre3 + ", proCant=" + proCant + ", proProvee=" + proProvee + ", proCate=" + proCate + ", proSect=" + proSect + ", proFoto=" + proFoto + ", proVenci=" + proVenci + ", proCanmin=" + proCanmin + ", proIva=" + proIva + ", proCbarra=" + proCbarra + ", proTiva=" + proTiva + ", proUnidad=" + proUnidad + '}';
    }
