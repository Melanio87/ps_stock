 ...
 * @author Melanio
 */
public class reg_Clientes extends javax.swing.JDialog {
    ...
    public reg_Clientes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(10, 50, 790, 150);
        ...
        jPanel1.add(txNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 40, 710, -1));
        ...
        jPanel1.add(txDirec, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, 719, -1));
        ...
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 189, -1, -1));
        ...
        jPanel1.setBounds(10, 200, 790, 230);
        ...
        setSize(new java.awt.Dimension(827, 529));
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        try {
            Integer cli_codigo;
            String sql = "Insert into clientes(cli_ci,cli_nombre,cli_tel,cli_direc,cli_fecnac,cli_ruc ) "
                    + "values(?,?,?,?,?,?)";
    ...
    private void refreshButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refreshButtonActionPerformed
        ...
        try {
            String sql = "UPDATE clientes set cli_ci=?,cli_nombre=?,"
                    + "cli_tel=?,cli_direc=?,cli_fecnac=?,cli_ruc=? where cli_codigo=? ";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                reg_Clientes dialog = new reg_Clientes(new javax.swing.JFrame(), true);
