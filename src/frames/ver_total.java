    ...
    private void GuaVenta() {
        ...
        try {
            ...
            sql = "Insert into ventas(ven_fecha,ven_hora,ven_codven,ven_total,"
                    + "ven_cliente,ven_tipo,ven_numfac,ven_efectivo,ven_vuelto,ven_descuento,ven_totlet) values('"
                    + ven.getVen_fecha() + "','"
                    + ven.getVen_hora() + "',"
                    + ven.getVen_codven() + ","
                    + ven.getVen_total() + ","
            ...
            if (rs.next()) {
                ...
                deucli dc = getDeu();
//                System.out.println("deuda : " + this.deu.toString());
                dc.setDcl_numven(codvent);
                dc.setDcl_codcli(Integer.parseInt(txCodcli.getText()));
                dc.setDcl_descli(txdescli.getText().trim());
                dc.setDcl_fecha(Cfecha.getTime());
            //dc.setDcl_monto(ven.getVen_saldo());

                sql = "insert into deucli(dcl_numven,dcl_monto,dcl_fecha,dcl_codcli,dcl_cancuo) values("
                        + codvent + "," + ven.getVen_saldo() + ",'" + ven.getVen_fecha() + "'," + ven.getVen_cliente() + "," + dc.getDcl_cancuo() + ")";
                stmt.executeUpdate(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ver_total.class
