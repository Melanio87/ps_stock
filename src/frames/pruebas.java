...
public class pruebas extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String cod = "1200015100058";
        int canText = cod.length();
        if (canText == 13) {
            int cbZ = Integer.parseInt(cod.substring(0, 1));
            int cbCP = Integer.parseInt(cod.substring(1, 7));
            int cbMont = Integer.parseInt(cod.substring(7, 12));
