...
public class AnularVentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Motivo de Anulación:");
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (!txNumVen.getText().isEmpty() && modelo.getRowCount() > 0 ) {
            if(!txMotivo.getText().isEmpty()){
                ...
                JOptionPane.showMessageDialog(null, "Escriba motivo de anulación");
                txMotivo.grabFocus();
            }
    ...
    private void anular() {
        try {
            ...
            int res;
            res = stmt.executeUpdate("insert into anuvent(avt_fecha,avt_hora,avt_codusu,avt_numven) values('"
                    + sdf.parse(fecha) + "','" + Hora + "'," + usu.getAcc_id() + "," + txNumVen.getText() + ")");
            con.commit();
            if (res == 1) {
